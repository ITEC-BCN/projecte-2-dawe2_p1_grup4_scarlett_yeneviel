      ...
      <div v-else>
          ...
          <table class="custom-table">
            ...
            <tbody>
              <tr v-for="oferta in ofertasPaginadas" :key="oferta.id">
                ...
                <td>
                  <div class="tag-row">
                    <span class="location-tag">{{ oferta.ubicacion.ciudad || 'No especificada' }} - {{ oferta.modalidad
        ...
        <div class="pagination-footer" v-if="totalPages > 1">
          ...
          <div class="pages-list">
            <button v-for="p in totalPages" :key="p" :class="['page-item', { active: p === currentPage }]"
              @click="goToPage(p)">
              {{ p }}
            </button>
          </div>
