...
<style scoped>
.espera-container { height: 80vh; display: flex; align-items: center; justify-content: center; text-align: center; }
.card { background: white; padding: 3rem; border-radius: 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.05); max-width: 450px; }
.icon { font-size: 4rem; margin-bottom: 1rem; }
h1 { color: #111827; margin-bottom: 1rem; }
p { color: #6b7280; line-height: 1.6; margin-bottom: 2rem; }
.btn-primary { background: #10b981; color: white; border: none; padding: 12px 24px; border-radius: 10px; font-weight: 700; cursor: pointer; width: 100%; }
.btn-link { background: none; border: none; color: #ef4444; margin-top: 1rem; cursor: pointer; text-decoration: underline; }
</style>